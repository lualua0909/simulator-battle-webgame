...
const weapons: WeaponDef[] = [
  ...
  W({ id: 'rex-bite', name: 'Ngoạm bạo chúa', attack: 'melee', damage: 220, damageType: 'slash', range: 3, cooldown: 1.9, windup: 0.6, knockback: 26, knockUp: 9, cleaveArc: 120, maxTargets: 5, hitParticleId: 'hit-chunk' }),
  W({ id: 'stego-tail', name: 'Quật đuôi gai', attack: 'melee', damage: 130, damageType: 'pierce', range: 2.8, cooldown: 1.7, windup: 0.55, knockback: 20, knockUp: 6, cleaveArc: 180, maxTargets: 6, hitParticleId: 'hit-chunk' }),
  ...
  W({ id: 'tri-horns', name: 'Húc sừng', attack: 'melee', damage: 110, damageType: 'pierce', range: 2.4, cooldown: 1.5, windup: 0.4, knockback: 18, knockUp: 5, cleaveArc: 100, maxTargets: 4, hitParticleId: 'hit-chunk' }),
...
const units: UnitDef[] = [
  ...
  U({ id: 'giant', name: 'Người khổng lồ', factionId: 'huyen-thoai', role: 'melee', cost: 1600, hp: 3000, speed: 3.4, mass: 25, radius: 1.3, height: 4.6, armorClass: 'beast', knockbackResist: 0.7, trampleDamage: 20, skillIds: ['nem-tang-da', 'dam-dat'], weaponId: 'giant-club', modelId: 'm-giant', description: 'Một gậy bay cả hàng.' }),
  ...
  U({ id: 't-rex', name: 'Khủng long T-Rex', factionId: 'huyen-thoai', role: 'melee', cost: 2500, hp: 3800, speed: 4.5, mass: 60, radius: 2.6, height: 5.2, armorClass: 'beast', chargeBonus: 1.5, knockbackResist: 0.85, trampleDamage: 50, skillIds: ['dam-dat'], weaponId: 'rex-bite', modelId: 'm-t-rex', description: 'Bạo chúa săn mồi, một ngoạm bay cả hàng, giẫm nát mọi thứ.' }),
  U({ id: 'stegosaurus', name: 'Khủng long Stegosaurus', factionId: 'huyen-thoai', role: 'melee', cost: 1400, hp: 2600, speed: 2.9, mass: 25, radius: 1.8, height: 3.4, armorClass: 'beast', knockbackResist: 0.75, trampleDamage: 25, weaponId: 'stego-tail', modelId: 'm-stegosaurus', description: 'Pháo đài gai, đuôi quật quét sạch xung quanh.' }),
  ...
  U({ id: 'triceratops', name: 'Khủng long Triceratops', factionId: 'huyen-thoai', role: 'melee', cost: 1200, hp: 2200, speed: 4.8, mass: 22, radius: 1.7, height: 3.6, armorClass: 'beast', chargeBonus: 2, knockbackResist: 0.7, trampleDamage: 30, weaponId: 'tri-horns', modelId: 'm-triceratops', description: 'Xe tăng ba sừng, húc bay mọi thứ dám cản đường.' }),
